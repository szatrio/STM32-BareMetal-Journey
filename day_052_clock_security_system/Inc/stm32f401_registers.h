...
// --- RCC Clock Security System (CSS) & HSE Bit Definitions ---
...
// --- RCC Clock Interrupt Register (CIR) Bit Definitions ---
#define RCC_CIR_CSSF          (1UL << 7)   // Clock security system interrupt flag
#define RCC_CIR_CSSC          (1UL << 23)  // Clock security system interrupt clear
...
// --- DMA Stream Register Struct Map ---
typedef struct {
...
// --- DMA Controller Register Struct Map ---
typedef struct {
    ...
    DMA_Stream_TypeDef Stream[8]; // Streams 0 to 7 (Offset: 0x10 - 0xBE)
} DMA_TypeDef;

// --- I2C Register Struct Map ---
typedef struct {
    volatile uint32_t CR1;   // Offset: 0x00 - Control Register 1
    volatile uint32_t CR2;   // Offset: 0x04 - Control Register 2
...
#define RCC_GPIOB_EN          (1UL << 1)
#define RCC_GPIOC_EN          (1UL << 2)
#define RCC_AHB1ENR_DMA1EN    (1UL << 21) // Bit 21: DMA1 clock enable
#define RCC_AHB1ENR_DMA2EN    (1UL << 22) // Bit 22: DMA2 clock enable
#define RCC_APB2ENR_SYSCFGEN  (1UL << 14) // Bit 14: Clock enable SYSCFG
#define RCC_APB2ENR_ADC1EN    (1UL << 8)  // Bit 8: ADC1 clock enable
#define RCC_APB1ENR_I2C1EN    (1UL << 21) // Bit 21: I2C1 clock enable
#define RCC_APB1ENR_TIM2EN    (1UL << 0)  // Bit 0: TIM2 clock enable
#define RCC_APB1ENR_PWREN     (1UL << 28) // Bit 28: Power interface clock enable
...
// SYSCFG External Interrupt Configuration Register index for Pin 13 (EXTICR4)
#define SYSCFG_EXTICR4_EXTI13_PC  (2UL << 4)
...
// --- DMA Stream Configuration Bit Definitions (S0CR - S7CR) ---
#define DMA_SxCR_EN           (1UL << 0)   // Bit 0: Stream Enable
#define DMA_SxCR_TCIE         (1UL << 4)   // Bit 4: Transfer Complete Interrupt Enable
#define DMA_SxCR_CIRC         (1UL << 8)   // Bit 8: Circular Mode
#define DMA_SxCR_DIR_P2M      (0UL << 6)   // Bits 7:6 = 00: Peripheral-to-memory
#define DMA_SxCR_DIR_M2P      (1UL << 6)   // Bits 7:6 = 01: Memory-to-peripheral
#define DMA_SxCR_MINC         (1UL << 10)  // Bit 10: Memory increment mode
#define DMA_SxCR_PINC         (1UL << 9)   // Bit 9: Peripheral increment mode
#define DMA_SxCR_PSIZE_8      (0UL << 11)  // Bits 12:11 = 00: Peripheral data size 8-bit
#define DMA_SxCR_PSIZE_16     (1UL << 11)  // Bits 12:11 = 01: Peripheral data size 16-bit
#define DMA_SxCR_MSIZE_16     (1UL << 13)  // Bits 14:13 = 01: Memory data size 16-bit
#define DMA_SxCR_PL_HIGH      (2UL << 16)  // Bits 17:16 = 10: Priority level High
#define DMA_SxCR_CHSEL_0      (0UL << 25)  // Channel Selection bits (000 = Channel 0)
#define DMA_SxCR_CHSEL_1      (1UL << 25)  // Channel Selection bits (001 = Channel 1)

// --- DMA Register Configuration Bit Definitions (LISR - LISFCR) ---
#define DMA_LISR_TCIF0    (1U << 5)   // Stream 0 Transfer Complete Flag
#define DMA_LIFCR_CTCIF0  (1U << 5)   // Clear Stream 0 Transfer Complete Flag

// --- I2C Register Bit Definitions ---
#define I2C_CR1_PE            (1UL << 0)     // Bit 0: Peripheral Enable
#define I2C_CR1_SMBUS         (1UL << 1)     // Bit 1: SMBus Mode (0 = I2C Mode)
#define I2C_CR1_START         (1UL << 8)     // Bit 8: Start Generation
#define I2C_CR1_STOP          (1UL << 9)     // Bit 9: Stop Generation
#define I2C_CR1_ACK           (1UL << 10)    // Bit 10: Acknowledge Enable
#define I2C_CR1_SWRST         (1UL << 15)    // Bit 15: Software Reset
#define I2C_CR2_FREQ_MASK     (0x3FUL << 0)  // Bits 5:0: Peripheral Clock Frequency (1-50 MHz)
#define I2C_CCR_FS            (1UL << 15)    // Bit 15: Fast Mode Select (0 = Standard, 1 = Fast)
#define I2C_CCR_DUTY          (1UL << 14)    // Bit 14: Fast Mode Duty Cycle
#define I2C_CCR_CCR_MASK      (0xFFFUL << 0) // Bits 11:0: Clock Control Divisor
#define I2C_SR1_SB            (1UL << 0)     // Bit 0: Start Bit Generated Flag

// --- PWR Register Bit Definitions ---
#define PWR_CR_LPDS           (1UL << 0)   // Low-power deep sleep
#define PWR_CR_PDDS           (1UL << 1)   // Power down deep sleep
#define PWR_CR_CSBF           (1UL << 3)   // Clear standby flag
#define PWR_CR_CWUF           (1UL << 2)   // Clear wake-up flag
...
// --- SCB SCR Bit Definitions (Sleep Mode) ---
#define SCB_SCR_SLEEPDEEP     (1UL << 2)   // 0 = Sleep mode, 1 = Deep sleep mode
#define SCB_SCR_SLEEPONEXIT   (1UL << 1)   // Sleep on exit from ISR

/* ====================================================================
 * SYSTEM INTRINSICS / UTILITY MACROS
 * ==================================================================== */
#ifndef __NOP
