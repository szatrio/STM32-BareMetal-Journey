...
// Enable DMA requests for ADC1 (Continuous DMA Transfer mode)
void ADC1_EnableDMA(void) {
    // Set bit DMA (bit 8) and DDS (bit 9) at ADC1->CR2
    // DMA: Enable DMA request when finish conversion
    // DDS: Keep DMA request activated for next conversion (Continuous Mode)
